...
- Healthy body (consistent routines, small sustainable tweaks)
- Healthy mind (routines, magic practice, social time)
- Intentional dating (new communities & outreach ideas)
- Time for friends/outings (flag if slipping)
...
1. LinkedIn / Anti-Gravity Performance
   ...
   - Produce daily + weekly refinements:
     • Recommended post type for next days (story, framework, cold sales, wisdom, automation, etc.)
     • Recommended 360 Brew comment style
     • Recommended lead magnet type (playbook, audit, reframing, etc.)
...
5. Crypto Opportunity Scan
   ...
   - Update crypto-opps-log.md with risk assessment.
   - Message Rui only if very high-confidence find (heavy disclaimer always).
